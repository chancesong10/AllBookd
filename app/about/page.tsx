 ...
 * - "The Old Way" vs "The AllBookd Way" feature comparison.
 * - Founder credits/links.
 * * Note: This component is purely presentational and optimized for dark mode.
 *
 * @returns {JSX.Element} The full About page layout.
 */
